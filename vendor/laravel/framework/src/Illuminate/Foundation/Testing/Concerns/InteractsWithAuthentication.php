...
trait InteractsWithAuthentication
{
    ...
    public function be(UserContract $user, $driver = null)
    {
        ...
        $this->app['emails']->guard($driver)->setUser($user);

        $this->app['emails']->shouldUse($driver);
    ...
    {
        return $this->app->make('emails')->guard($guard)->check();
    }
    ...
    {
        $expected = $this->app->make('emails')->guard($guard)->user();
    ...
    {
        $provider = $this->app->make('emails')->guard($guard)->getProvider();
