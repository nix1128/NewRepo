 ...
 * @method Swift_SmtpTransport setAuthMode(string $mode)     Set the emails mode to use to authenticate.
 * @method string              getAuthMode()                 Get the emails mode to use to authenticate.
 */
