...
//
        ...
        //$user->phone;
        //dd($user->phone->phone); find phone filed

        //add update phone with
        if ($user->phone === null) {
...
//        //dd($name);
        return redirect('profile')->with($name)->with('success','');
...

            {
                ...
                $image_path = public_path('storage/' . $user->card->image, 90);  // Value is not URL but directory file path
