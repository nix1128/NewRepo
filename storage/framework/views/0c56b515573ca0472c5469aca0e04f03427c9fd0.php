            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body ">
                        ...
                        <form method="post" action="<?php echo e(route('resetPassword', $token =  csrf_token() )); ?>">
                            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                            <input type="hidden" size="40" name="email" value="<?php echo e(request('email')); ?>">
...
<?php echo $__env->make('frontview.layouts.welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\Laravel\blog\resources\views/frontview/layouts/reset.blade.php ENDPATH**/ ?>