...
<?php echo csrf_field(); ?>
                    ...
                    <div class="form-group has-error">
                        ...
                        <input type="text" class="form-control"   name="subject" value="<?php echo e(old('subject')); ?> <?php if(empty($v->subject) ): ?> <?php else: ?><?php echo e($v->subject); ?> <?php endif; ?>"  />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title"  value="<?php echo e(old('title')); ?> <?php if(empty($v->title)): ?> <?php else: ?><?php echo e($v->title); ?> <?php endif; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="5" class="form-control"  name="body" value = "<?php echo e(old('body')); ?>"> <?php if(empty($v->body)): ?> <?php else: ?> <?php echo e($v->body); ?> <?php endif; ?></textarea>
...
<?php echo $__env->make('frontview.layouts.userView', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\Laravel\blog\resources\views/posts/edit.blade.php ENDPATH**/ ?>