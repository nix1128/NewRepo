...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <label for="slug" class="text-primary" >Тема </label> <span class="require"> *</span> <small> (не се позволява дублиране на теми)</small>
            <label for="slug" class="text-primary text-md-right col-4">Дата </label><span class="require">*</span> <small>(от дата на гласуване)</small>
            </div>
                ...
                <div class="form-group has-error">
                    ...
                    <div class = "  d-lg-inline-flex  justify-content-md-right">
                        ...
                        <div class = "container col-lg-1">
                                ...
                                <input   type = "datetime" id="datepicker" width="250" name = "data" data-format="dd-mm-yyyy"/>
                                <script>
